  ...
  list.forEach((p, index) => {
    ...
    card.innerHTML = `
      ...
      <div class="product-info">
        ...
        <div class="product-trust">✅ Premium Quality<br>✅ Fast Delivery<br>✅ Free VIP Discount Card Included<br><span>Get 10% OFF your next order when you scan the card inside your package.</span></div>
...
function prettyCategory(c) {
  const names = { club: "Club Jerseys", national: "National Jerseys", retro: "Retro Jerseys" };
  return names[c] || c.split("-").map(x => x[0].toUpperCase() + x.slice(1)).join(" ");
}
